        ...
        <div className={styles.card}>
          ...
          <div className={styles.settingRow}>
            <div>
              ...
              <p className={styles.settingDesc}>Get notified when students request mentorship sessions.</p>
            </div>
          ...
          <div className={styles.settingRow}>
            <div>
              ...
              <p className={styles.settingDesc}>Receive personalized job & recruitment digest alerts.</p>
            </div>
            <Switch defaultChecked onChange={() => message.success('Preferences saved!')} />
          </div>
        </div>

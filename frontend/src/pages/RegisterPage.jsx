...
export const RegisterPage = () => {
  ...
  const onFinish = async (values) => {
    setLoading(true);
    try {
      console.log('Alumni Registration Values:', values);
      const result = await authService.register({
        ...values,
        role: 'alumni'
      });
      if (result.success) {
        message.success('Alumni registration successful! Redirecting to dashboard...');
      ...
      <div className={styles.rightFormColumn}>
        <div className={styles.formContentWrapper}>
          ...
          <div className={styles.formHeader}>
            ...
            <p className={styles.pageSubtitle}>Join the AlumniConnect network as a verified alumnus.</p>
          </div>

          {/* Ant Design Registration Form - Alumni Only */}
          <Form
            form={form}
            name="register_form"
            onFinish={onFinish}
          ...
          >
            <div className={styles.formGrid}>
              ...
              <div>
                ...
                >
                  <Input placeholder="e.g. John Doe" className={styles.customInput} />
                </Form.Item>
              </div>
              ...
              <div>
                ...
                >
                  <Input placeholder="e.g. 2020" className={styles.customInput} />
                </Form.Item>
              </div>
